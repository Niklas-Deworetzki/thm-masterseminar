...
\begin{figure}
  ...
  \begin{tikzpicture}[
    ...
    \draw [arrow] (input1) -- (prog);
    \draw [arrow] (input2) -- (prog);
    \draw [arrow] (input3) -- (prog);
...
\begin{figure}
  ...
  \begin{tikzpicture}[
    ...
    \draw [arrow] (source) -- (pe);
    \draw [arrow] (pe) -- (residual);

    \draw [arrow] (input1) -- (pe);
    \draw [arrow] (input2) -- (residual);
    \draw [arrow] (input3) -- (residual);
